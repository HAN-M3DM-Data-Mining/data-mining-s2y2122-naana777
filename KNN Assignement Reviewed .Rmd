...
# Should be x-max(x)/max(x)-min(x) instead of ((x - max(x)) / (max(x) + min(x)))
...
trainDF_feat <- cleanDF_n[4072:8143, 4]
# Should be testDF_feat for the second line instead of trainDF_feat
